  ...
  return (
    <div>
      <div className="relative grid grid-cols-2 overflow-y-hidden text-center font-bold uppercase">
        <img
          src="/main_logo.svg"
          className="absolute left-0 top-0 z-30 h-full w-full px-10 opacity-40"
        />
        <div className="absolute top-0  left-0 z-20 h-[100vh] w-1/2 bg-red-500 "></div>
        ...
        <div className="absolute top-0  right-0 z-20 h-[100vh] w-1/2 bg-green-500"></div>
        <div className="z-40 h-[100vh]">
